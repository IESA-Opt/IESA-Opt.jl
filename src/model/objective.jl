...
function add_objective!(m::JuMP.Model, vars::AnnualVars, md::ModelData)
    ...
    for ps in pss
        ...
        # IESA-Opt 1.0 totalCosts has two separate deltaS_shed terms:
        #   + deltaS_shed * vom_cost      (avoided VOM because deltaS_shed <= 0)
        #   - deltaS_shed * shed_penalty  (positive shedding penalty)
